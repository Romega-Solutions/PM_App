...
| ---------------------- | -------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| PM_App local quality | Pass locally; external proof still required | `npm run check:local-quality` and `npm run check:release-local` pass on current HEAD | Current local release gate passed on 2026-07-01: secret hygiene, dependency audit with 0 vulnerabilities, ownership contract, safety operations contract, launch evidence contract, source contracts, lint, TypeScript, 20 Jest suites / 136 tests, and Expo web export. This does not prove live Supabase, OCR, native device, mailbox, or store/account ownership behavior. |
...
| Safety operations | Pass | Named safety/support/legal/release owners, SLAs, escalation path, and evidence-handling rules | `docs/operations/SAFETY_MODERATION_RUNBOOK.md` carries the owner table; trimmed one-off evidence is indexed in `docs/evidence/README.md`. |
...
| PM_App production ownership release gate | `npm run check:release-local` | Pass | Codex | 2026-06-11 | `docs/evidence/README.md` |
| PM_App safety operations release gate | `npm run check:safety-operations-contract` | Pass | Codex | 2026-06-11 | `docs/evidence/README.md` |
| PM_App launch evidence release gate | `npm run check:launch-evidence-contract` | Pass | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| Product design QA standard | `docs\testing\PRODUCT_DESIGN_QA_STANDARD.md` | Source standard added, design QA not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PM_Web standalone read-only checks | `PM_Web/scripts/check-launch-claims.mjs` / `PM_Web/scripts/check-local-cta-links.mjs` / `PM_Web/scripts/check-product-design-contract.mjs` / `PM_Web/docs/release/PINAYMATE_LAUNCH_STATE_MATRIX.md` | Source/scripts updated, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PM_App profile photo owner preflight | Source, focused profile/account photo tests, and static-contract patch | Pass | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PinayMate launch-state matrix | `docs/release/PINAYMATE_LAUNCH_STATE_MATRIX.md` plus PM_App/PM_Web source contracts | Source matrix and feature proof map added, contracts not rerun | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PM_App native QA safety coverage | `docs\testing\NATIVE_QA_SCRIPT.md` | Checklist updated, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
| PM_App native QA privacy/media refresh | `docs\testing\NATIVE_QA_SCRIPT.md` | Checklist updated, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
| PM_App launch-state notice native QA coverage | `docs\testing\NATIVE_QA_SCRIPT.md` | Checklist updated, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
| PM_App native QA selector contract | `scripts/check-launch-file-contract.mjs` / `docs\testing\NATIVE_QA_SCRIPT.md` | Source contract guard added, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| Launch evidence native QA template contract | `scripts/check-launch-evidence-contract.mjs` / `docs\release\LAUNCH_EVIDENCE_PACKET.md` | Source contract guard added, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| Supabase release operator checklist | `docs\operations\SUPABASE_RELEASE_OPERATOR_CHECKLIST.md` | Source runbook added, live execution not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
| Supabase operator notification proof map | `docs\operations\SUPABASE_RELEASE_OPERATOR_CHECKLIST.md` / `supabase/LAUNCH_MIGRATION_MANIFEST.md` | Source docs updated, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| Launch evidence Supabase template contract | `scripts/check-launch-evidence-contract.mjs` / `docs\release\LAUNCH_EVIDENCE_PACKET.md` | Source contract guard added, not run | Codex | 2026-06-11 | `docs/evidence/README.md` |
| Supabase live proof command checklist | `docs\operations\SUPABASE_LIVE_PROOF_COMMANDS.md` | Operator command checklist added, live proof not captured | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PM_App dependency audit gate | `npm run check:dependency-audit` | Pass: 0 vulnerabilities | Codex | 2026-07-01 | Local `npm run check:release-local` output |
| PM_App dependency audit decision control | `docs\operations\DEPENDENCY_AUDIT_REMEDIATION.md` | Decision workflow remains available for future advisories; current audit passed | Codex | 2026-07-01 | Local `npm run check:release-local` output |
...
| PM_App secret hygiene remediation runbook | `docs\operations\SECRET_HYGIENE_REMEDIATION.md` | Runbook added, cleanup not executed | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| Launch signoff checklist | `docs\release\LAUNCH_SIGNOFF_CHECKLIST.md` | Updated with current `.env` blocker and local gate commands | Codex | 2026-06-11 | `docs/evidence/README.md` |
| Release control owner board | `docs\release\PINAYMATE_RELEASE_RISK_REGISTER.md` / `docs\release\LAUNCH_SIGNOFF_CHECKLIST.md` | Owner-based go/no-go controls added, not validated | Codex | 2026-06-11 | `docs/evidence/README.md` |
| Production ownership and safety roster | `docs\release\PRODUCTION_OWNERSHIP_CHECKLIST.md` / `docs\operations\SAFETY_MODERATION_RUNBOOK.md` | Owner/backup/triage controls added, not validated | Codex | 2026-06-11 | `docs/evidence/README.md` |
...
| PM_Web waitlist Edge header contract guard | `PM_Web/scripts/check-waitlist-backend-handoff.mjs` / `PM_Web/scripts/check-product-design-contract.mjs` / `PM_Web/docs/evidence/README.md` / `PM_Web/RELEASE_CHECKLIST.md` / `PM_Web/src/lib/waitlistBackendHandoff.ts` | Dedicated source, checklist, and handoff-doc guard added; prevents service-role, Authorization, and Bearer anon-token regressions in public waitlist capture, and now runs inside PM_Web `check:release-local` | Codex | 2026-06-11 | `PM_Web/docs/evidence/README.md` |
...
| Copy accuracy | no fake live matching, checkout, app-store, or guaranteed-safety claims | Pass | Codex local QA | 2026-06-11 | Local source and preview proof: `PM_Web/docs/evidence/README.md`, `PM_Web/docs/evidence/README.md`, and `PM_App/docs/evidence/README.md`; production domain proof remains external. |
