...
- `docs/SUPABASE_RELEASE_OPERATOR_CHECKLIST.md` tells the backend/release operator to capture notification preference preflight proof, smoke proof, and matrix-based backend feature proof before launch-ready backend claims.
