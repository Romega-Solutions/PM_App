...
- [TESTING_GUIDE.md](../testing/TESTING_GUIDE.md) - Testing strategies and examples
- [SMART_MATCHING_ALGORITHM.md](../product/SMART_MATCHING_ALGORITHM.md) - Matching algorithm documentation
