...
photo = photo.replace('import { theme } from "@/src/theme";', 'import { useAppTheme, makeStyles } from "@/src/theme";');
...
photo = photo.replace(/theme\.colors\./g, 'theme.colors.'); // Already uses theme.colors
...
welcome = welcome.replace(/const ACCENT_PURPLE = theme\.colors\.dalisay\?\.\[500\] \?\? "#8D69F6";\n/, '');
welcome = welcome.replace(/const ACCENT_PINK = theme\.colors\.amihan\?\.\[500\] \?\? "#EF3E78";\n/, '');
