...
export default function GenderPreferenceOption({
  option,
  selected,
  onSelect,
}: Props) {
  ...
  return (
    <TouchableOpacity
      ...
      accessibilityLabel={`Discovery preference: ${option}${selected ? ", selected" : ""}`}
      accessibilityHint="Updates who you prefer to see when discovery is available."
