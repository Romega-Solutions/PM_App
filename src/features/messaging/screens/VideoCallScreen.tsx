    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.statusCard}>
          ...
          <Text style={styles.title}>Video calls are off for launch</Text>
          <Text style={styles.description}>
            This build keeps video calls disabled until the calling provider,
            consent flow, abuse controls, and support process are verified. No
            call was started and no camera or microphone permission was
            requested.
          </Text>
        ...
        <Pressable
          ...
          accessibilityHint="Closes this unavailable video call screen"
        >
          <LinearGradient
